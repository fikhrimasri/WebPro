				...
				<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
					<div class="card card-signin my-5">
						<div class="card-body">
                        	...
                        	?>
                        	<form method="POST" action="<?php echo site_url('UserController/signIn'); ?>" method="POST" class="register-form" id="login-form">
                                ...
                                <a href="<?php echo base_url();?>index.php/C_Auth/set" class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Sign in</a>
                                <hr class="my-4">
